...
- **Library** — B-roll (browse the folders, search what is in the shot, or paste a script or upload an .srt and get ranked clips for each beat, swap any pick, see the footage still to shoot, and export a timeline for Premiere or Resolve), Music (drag and drop as many tracks as you like; **categorise the ones marked with a red !**), References, and the SOP / Playbook.
