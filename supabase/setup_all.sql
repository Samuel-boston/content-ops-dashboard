-- ============================================================================
-- ONE-FILE DATABASE SETUP for a brand-new Supabase project.
-- = schema.sql followed by every migration in order. Paste into Supabase → SQL Editor and Run once.
-- Regenerate after adding a migration:  npm run build:sql
-- ============================================================================
